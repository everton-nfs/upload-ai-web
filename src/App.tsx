...
export function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <div className="px-6 py-3 flex items-center justify-between border-b sticky top-0 z-10 bg-[#030712]">
      ...
      <main className="flex-1 p-8 flex gap-6">
        ...
        <aside className="w-80 space-y-6">
          <form className="space-y-6">
            <label
              htmlFor="video"
              className="border flex rounded-md aspect-video cursor-pointer border-dashed text-sm flex-col gap-2 items-center justify-center text-muted-foreground hover:bg-primary hover:text-white"
            >
              <FileVideo />
              Selecione um vídeo
            </label>
